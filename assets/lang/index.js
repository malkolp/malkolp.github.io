window.lang_en      = [
    ...
    {
        target      : 'nav-item-about',
        value       : 'About',
    },
    {
        target      : 'nav-item-experience',
        value       : 'Experience',
    },
    {
        target      : 'nav-item-work',
        value       : 'Work',
    },
    {
        target      : 'nav-item-contact',
        value       : 'Contact',
    },
    {
        target      : 'subtitle-detail',
        value       : 'Software Engineer & Software Developer',
    },
    {
...
window.lang_cn      = [
    ...
    {
        target      : 'about-intro-p2',
        value       : '此外，积极在电子商务、信息系统领域进行研究，目前正在发明可应用于教育业务数字化转型过程的新技术。',
    },
    {
        target      : 'experience-title',
        value       : '经验',
